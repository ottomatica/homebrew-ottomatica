class Baker < Formula
  ...
  devel do
    url "https://github.com/ottomatica/baker-release/releases/download/0.4.1/baker-macos-0.4.1.tar.gz"
    sha256 "950d4381b0b106d346b89694ae4a0c21c0889635e0f0cf06e2faf109aebb6db9"
  end
