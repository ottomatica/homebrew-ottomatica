class Baker < Formula
  ...
  devel do
    url "https://github.com/ottomatica/baker-release/releases/download/0.4.3/baker-macos-0.4.3.tar.gz"
    sha256 "582d3d5cf9682236a5964fb5243f8e570629c93706b135ab4b6b4b4fc2753cb4"
  end
